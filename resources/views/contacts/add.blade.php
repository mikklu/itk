...
{{-- Yhteystiedon lisäys -sivu --}}
@section('content')
    <div class="container col-lg-5 py-3 mb-3 shadow rounded-bottom bg-white">

        {{-- Otsikko --}}
        <h2 class="pb-3">Lisää uusi yhteystieto</h2>

        {{-- Lomake uuden yhteystiedon lisäystä varten --}}
        <form action="{{ route('add_contact') }}" method="post">
            ...
            <div class="row">
                <div class="col-6 mb-3">
                    ...
                    placeholder="Yhteystiedon nimi" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="col-6 mb-3">
                    ...
                    placeholder="Yritys tai muu taho" value="{{ old('company') }}">
                </div>
            </div>
            ...
            <div class="row align-items-end">
                ...
                <div class="col-auto mb-3">
                    <div class="form-check mb-2">
                        ...
                        @if(old('is_client')) checked @endif >
                ...
                <div class="col-auto mb-3">
                    <div class="form-check mb-2">
                        ...
                        @if(old('is_instructor')) checked @endif >
